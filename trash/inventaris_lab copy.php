<div class="page-heading">
          <div class="page-title">
            <div class="row">
              <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <div class="buttons">
                      <a href="index.php?r=lihat_inventarisLab" class="btn btn-success">Kembali</a>
          ...
          <?php
            ...
            if (isset($_POST['idLab'])) {
              $idLab = $_POST["idLab"];
              if ($idLab == 'semua') {
                $sqlkelas = "select * from inventaris_lab";
              } else {
                $sqlkelas = "select * from inventaris_lab where id_laboratorium = '".$idLab."'";
              }
            } else {
              // Handle jika tidak diatur
              $sqlkelas = "select * from inventaris_lab";
            }
