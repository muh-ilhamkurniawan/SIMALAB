              ...
              <li class="sidebar-item has-sub">
                ...
                <ul class="submenu">
                  <li class="submenu-item">
                    <a href="laboratorium.php">Informasi Laboratorium</a>
                  </li>
                  <li class="submenu-item">
                    <a href="petugas.php">Organisasi Laboratorium</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item active has-sub">
                ...
                <ul class="submenu active">
                  <li class="submenu-item active">
                    <a href="buat_surat_bebas.php">Buat Surat</a>
                  </li>
                  <li class="submenu-item">
                    <a href="surat_bebas.php">Lihat Surat</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item has-sub">
              ...
              <div>
                <div class="card">
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <form class="form form-horizontal" action="proses_surat_bebas.php" method="POST" target="_blank">
                        <div class="form-body">
                          <div class="row">
                            <div class="col-md-2">
