          <div class="sidebar-menu">
            <ul class="menu">
              ...
              <li class="sidebar-item <?php echo ($currentPage === 'buat_surat_penelitian' || $currentPage === 'surat_penelitian') ? 'active' : ''; ?> has-sub">
                <a href="#" class="sidebar-link">
                  <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                  <span>Surat Selesai Penelitian</span>
                </a>
                <ul class="submenu <?php echo ($currentPage === 'buat_surat_penelitian' || $currentPage === 'surat_penelitian') ? 'active' : ''; ?>">
                  ...
                  <li class="submenu-item <?php echo ($currentPage === 'surat_penelitian') ? 'active' : ''; ?>">
                    <a href="index.php?r=surat_penelitian">Lihat Surat</a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item <?php echo ($currentPage === 'buat_surat_peminjaman' || $currentPage === 'surat_peminjaman') ? 'active' : ''; ?> has-sub">
                <a href="#" class="sidebar-link">
                  <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                  <span>Surat Peminjaman</span>
                </a>
                <ul class="submenu <?php echo ($currentPage === 'buat_surat_peminjaman' || $currentPage === 'surat_peminjaman') ? 'active' : ''; ?>">
                  ...
                  <li class="submenu-item <?php echo ($currentPage === 'surat_peminjaman') ? 'active' : ''; ?>">
                    <a href="index.php?r=surat_peminjaman">Lihat Surat</a>
                  </li>
                </ul>
              </li>
