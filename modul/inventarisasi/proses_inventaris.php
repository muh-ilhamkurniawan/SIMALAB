...
if (isset($_POST['simpan'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($cekId->num_rows > 0) {
            ...
            $sql = "INSERT INTO inventaris (id, nama, merk, spesifikasi, jumlah, fungsi, sumber, tahun, kondisi, penggunaan, keterangan) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if ($stmt) {
                ...
                $stmt->bind_param("sssssssssss", $id, $nama, $merk, $spesifikasi, $jumlah, $fungsi, $sumber, $tahun, $kondisi, $penggunaan, $keterangan);
...
if (isset($_POST['edit'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $keterangan = $_POST["keterangan"];
            ...
            $sql = "UPDATE inventaris SET nama='$nama', merk='$merk', spesifikasi='$spesifikasi', jumlah='$jumlah', fungsi='$fungsi', sumber='$sumber', tahun='$tahun', kondisi='$kondisi', penggunaan='$penggunaan', keterangan='$keterangan' WHERE id='$id'";
